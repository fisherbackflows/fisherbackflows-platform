...
export default function CompanyDirectoryPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 to-cyan-900">
      {/* Header */}
      <header className="bg-black/20 backdrop-blur-sm border-b border-cyan-400/20">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredCompanies.map((company) => (
            <div 
              key={company.id}
              className="bg-white/10 backdrop-blur-sm border border-cyan-400/20 rounded-xl p-6 hover:scale-105 transition-all duration-200 hover:border-cyan-400/40"
            >
              {/* Company Header */}
              ...
              <div className="space-y-2 mb-4">
                ...
                {company.contact_phone && (
                  <div className="flex items-center text-cyan-300 text-sm">
                    ...
                    <a href={`tel:${company.contact_phone}`} className="hover:text-white transition-colors">
                      {company.contact_phone}
                    </a>
                  </div>
                )}
              ...
              <Link
                ...
                className="block w-full text-center px-4 py-3 rounded-lg font-semibold transition-all duration-200 text-white hover:scale-105"
                style={{ 
                  backgroundColor: company.primary_color,
                  boxShadow: `0 4px 20px ${company.primary_color}30`
                }}
              >
        ...
        {/* Help Section */}
        <div className="mt-12 bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-cyan-400/20">
          <div className="text-center">
            ...
            <Link
              ...
              className="inline-flex items-center px-6 py-3 bg-cyan-600 text-white rounded-lg font-semibold hover:bg-cyan-700 transition-colors"
            >
