...
export default function CreateReminderPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      router.push('/tester-portal/reminders')
    }, 1000)
  }
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto p-6">
        {/* Header */}
        <div className="mb-8">
          <Link href="/tester-portal/reminders" className="inline-flex items-center text-blue-400 hover:text-blue-300 mb-4">
            <ArrowLeft className="w-4 h-4 mr-2" />
            Back
          </Link>
          <h1 className="text-3xl font-bold">Create Reminder</h1>
          <p className="text-gray-400 mt-2">Set up a new reminder for testing or maintenance</p>
        </div>
