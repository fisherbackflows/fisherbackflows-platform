    ...
    <div className="min-h-screen bg-black">
          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-4">
              <Link href="/" className="flex items-center space-x-2">
                <div className="w-8 h-8 rounded-lg glass-btn-primary glow-blue flex items-center justify-center">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="text-blue-300 font-semibold">Tester Portal API</span>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-4">
              ...
              <Link
                ...
                className="glass-btn-primary glow-blue text-white px-4 py-2 rounded-2xl font-semibold transition-all"
              >
                Get API Access
              </Link>
            </div>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="mb-8">
            <div className="inline-flex items-center space-x-2 glass border border-blue-400 rounded-full px-4 py-2 text-blue-300 text-sm font-medium mb-6 glow-blue-sm">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            <Link
              ...
              className="glass-btn-primary glow-blue text-white px-8 py-4 rounded-2xl font-semibold text-lg transition-all flex items-center justify-center"
            >
              View API Docs
            ...
            <Link
              ...
              className="glass border border-blue-400 text-blue-300 hover:text-blue-400 px-8 py-4 rounded-2xl font-semibold text-lg transition-all"
            >
              Try Live Demo
            </Link>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="text-center">
              ...
              <div className="text-blue-300">API Uptime</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-white mb-2">&lt;200ms</div>
              <div className="text-blue-300">Average Response</div>
            </div>
            <div className="text-center">
      ...
      <section className="py-20 bg-black/40 backdrop-blur-xl">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Customer Management */}
            <div className="glass border border-blue-400 rounded-xl p-6 hover:glow-blue transition-all">
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {/* Starter */}
            <div className="glass border border-blue-400 rounded-xl p-8">
              <div className="text-center mb-6">
                <h3 className="text-2xl font-bold text-white mb-2">Starter</h3>
                <div className="text-4xl font-bold text-blue-300 mb-2">$99<span className="text-lg text-blue-300">/mo</span></div>
                <p className="text-white/80">Up to 500 customers</p>
              </div>
              ...
              <Link
                ...
                className="block w-full text-center glass-btn-primary glow-blue text-white py-3 rounded-lg font-semibold hover:glow-blue transition-colors"
              >
                Start Free Trial
              </Link>
            </div>
            ...
            {/* Professional */}
            <div className="glass glow-blue border-2 border-blue-400 rounded-xl p-8 relative">
              <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                <span className="glass-btn-primary glow-blue text-white px-6 py-2 rounded-full text-sm font-semibold">
                  Most Popular
                </span>
              </div>
              <div className="text-center mb-6">
                <h3 className="text-2xl font-bold text-white mb-2">Professional</h3>
                <div className="text-4xl font-bold text-blue-300 mb-2">$299<span className="text-lg text-blue-300">/mo</span></div>
                <p className="text-white/80">Up to 2,000 customers</p>
              </div>
              <ul className="space-y-3 mb-8">
                <li className="flex items-center text-white/80">
                  <CheckCircle className="h-5 w-5 mr-3 text-green-400" />
              ...
              <Link
                ...
                className="block w-full text-center glass-btn-primary glow-blue text-white py-3 rounded-lg font-semibold hover:glow-blue transition-all"
              >
                Start Free Trial
              </Link>
            </div>
            ...
            <div className="glass border border-blue-400 rounded-xl p-8">
              <div className="text-center mb-6">
                ...
                <div className="text-4xl font-bold text-blue-300 mb-2">Custom</div>
                <p className="text-white/80">Unlimited customers</p>
              </div>
              <ul className="space-y-3 mb-8">
                <li className="flex items-center text-white/80">
                  <CheckCircle className="h-5 w-5 mr-3 text-green-400" />
      ...
      <section className="py-20 bg-black/40 backdrop-blur-xl">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/tester-portal/signup"
              className="glass-btn-primary glow-blue text-white px-8 py-4 rounded-xl font-semibold text-lg hover:glow-blue transition-all"
            >
              Start Free Trial
            </Link>
            <Link
              href="/tester-portal/demo"
              className="border border-blue-400 text-blue-300 px-8 py-4 rounded-xl font-semibold text-lg hover:bg-blue-600/20 transition-all"
            >
              Schedule Demo
            </Link>
          </div>
