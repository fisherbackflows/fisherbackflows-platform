...
export default function CreateInvoicePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      router.push('/tester-portal/invoices')
    }, 1000)
  }
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto p-6">
        {/* Header */}
        <div className="mb-8">
          <Link href="/tester-portal/invoices" className="inline-flex items-center text-blue-400 hover:text-blue-300 mb-4">
            <ArrowLeft className="w-4 h-4 mr-2" />
            Back
          </Link>
          <h1 className="text-3xl font-bold">Create Invoice</h1>
          <p className="text-gray-400 mt-2">Create a new invoice for a customer</p>
        </div>
