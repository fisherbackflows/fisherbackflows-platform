    ...
    <div className="min-h-screen bg-black">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              <Link href="/tester-portal/dashboard" className="bg-blue-500/20 border border-blue-400 glow-blue-sm hover:glow-blue/30 p-2 rounded-lg transition-colors">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="bg-black/40 backdrop-blur-sm border border-blue-400/20 rounded-xl p-6">
            ...
            <div className="space-y-6">
              <div>
                ...
                <select
                  className="w-full px-4 py-3 bg-black/20 border border-blue-400/30 rounded-lg focus:ring-2 focus:ring-blue-400 focus:border-blue-400 text-white"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    type="text"
                    className="w-full px-4 py-3 bg-black/20 border border-blue-400/30 rounded-lg focus:ring-2 focus:ring-blue-400 focus:border-blue-400 text-white placeholder-cyan-300"
          ...
          <div className="bg-black/40 backdrop-blur-sm border border-blue-400/20 rounded-xl p-6">
            ...
            <div className="space-y-4">
              {formData.testResults.map((test, index) => (
                <div key={test.id} className="bg-black/20 border border-blue-400/20 rounded-lg p-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                      ...
                      <input
                        type="number"
                        step="0.1"
                        className="w-full px-3 py-2 bg-black/20 border border-blue-400/30 rounded-lg focus:ring-2 focus:ring-blue-400 focus:border-blue-400 text-white placeholder-cyan-300"
            ...
            {/* Overall Status */}
            <div className="mt-6 p-4 rounded-lg bg-black/20 border border-blue-400/20">
              <div className="flex items-center justify-between">
                ...
                <div className="mt-4">
                  <div className="flex items-center space-x-2 mb-3">
                    <input
                      ...
                      className="rounded border-blue-400/50 text-blue-300 focus:ring-blue-400"
                    />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-black/40 backdrop-blur-sm border border-blue-400/20 rounded-xl p-6">
              ...
              <textarea
                className="w-full px-4 py-3 bg-black/20 border border-blue-400/30 rounded-lg focus:ring-2 focus:ring-blue-400 focus:border-blue-400 text-white placeholder-cyan-300 resize-none"
                rows={4}
            ...
            <div className="bg-black/40 backdrop-blur-sm border border-blue-400/20 rounded-xl p-6">
              ...
              <div className="text-center py-8 border-2 border-dashed border-blue-400/30 rounded-lg">
                <Camera className="h-12 w-12 text-blue-300 mx-auto mb-4" />
                <button 
                  type="button" 
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <button 
              ...
              disabled={saving || !formData.customerId} 
              className="flex-1 glass-btn-primary glow-blue text-white px-6 py-3 rounded-xl font-semibold disabled:opacity-50 disabled:cursor-not-allowed transition-all"
            >
              <Save className="h-5 w-5 inline mr-2" />
