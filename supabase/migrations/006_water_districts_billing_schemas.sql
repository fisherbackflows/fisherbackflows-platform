-- Create water_districts and billing system tables
-- Migration: 006_water_districts_billing_schemas.sql

-- First: Create water_districts table
...
-- Second: Create billing_subscriptions and billing_invoices tables
