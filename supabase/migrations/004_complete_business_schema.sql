...
-- This creates ALL missing tables needed for full functionality
...
CREATE TABLE IF NOT EXISTS public.appointments (
  ...
  travel_time INTEGER DEFAULT 15, -- minutes
...
-- ============================================================================
-- PAYMENTS TABLE (Enhanced from previous migration)
-- ============================================================================
...
-- ============================================================================
-- LEADS TABLE (Enhanced from previous migration)
-- ============================================================================
...
-- ============================================================================
-- WATER DEPARTMENT SUBMISSIONS TABLE (Enhanced)  
-- ============================================================================
...
-- Payments indexes (from previous migration)
...
-- Leads indexes (from previous migration)
CREATE INDEX IF NOT EXISTS idx_leads_status ON public.leads(status);
CREATE INDEX IF NOT EXISTS idx_leads_assigned_to ON public.leads(assigned_to);
CREATE INDEX IF NOT EXISTS idx_leads_created_at ON public.leads(created_at DESC);

-- Water Department indexes (from previous migration)
...
-- Insert sample team user for testing
