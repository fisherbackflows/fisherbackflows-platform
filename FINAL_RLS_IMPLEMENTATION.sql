-- ===================================================================
-- FINAL RLS IMPLEMENTATION FOR FISHER BACKFLOWS PLATFORM
-- ===================================================================
-- This script fixes all type casting issues (UUID vs TEXT)
...
-- ===================================================================
-- 4. TEAM-ONLY ACCESS POLICIES (FIXED TYPE CASTING)
-- ===================================================================
...
-- Team Sessions: Own sessions + Admin access (FIXED: proper type casting)
...
-- Time Off Requests: Own requests + Admin approval (FIXED: proper type casting)
...
-- ===================================================================
-- 8. NOTIFICATION AND COMMUNICATION POLICIES (FIXED TYPE CASTING)
-- ===================================================================
...
-- Push Subscriptions: Own subscriptions only (FIXED: proper type casting)
...
-- Notification Logs: Own notifications + Team access (FIXED: proper type casting)
...
-- Notification Interactions: Team access only (no direct user reference)
...
-- ===================================================================
-- 9. EMAIL VERIFICATION POLICIES (FIXED TYPE CASTING)
-- ===================================================================
...
-- Users can read their own email verifications (FIXED: proper type casting)
